...
// 1. Export static groups directly so AddNumbersModule can read them
...
// 2. Export static campaigns directly
...
// 3. Export live mutable contacts directly
export const contacts: Contact[] = Array.from({ length: 120 }).map((_, i) => {
